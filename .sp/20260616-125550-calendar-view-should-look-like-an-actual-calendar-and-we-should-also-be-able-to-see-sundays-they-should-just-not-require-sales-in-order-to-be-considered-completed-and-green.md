...
this is how we want things running, we want an actualy calendar view and the calendar where we click days to upload data is seperate from the section where we can generate sales data so please parse these out as their own sections as well it should look like a real calendar no just xxxx-xx-xx dates please
